import { reactive as A1, openBlock as b, createElementBlock as m, normalizeStyle as q, createCommentVNode as R, renderSlot as O, createTextVNode as Nu, toDisplayString as K, createElementVNode as y, resolveComponent as T, createVNode as N, withCtx as j, resolveDirective as y1, normalizeClass as DD, withDirectives as Rf, createBlock as V, Fragment as Ru, renderList as Qu, vShow as w1, withModifiers as Gu, pushScopeId as k1, popScopeId as x1, nextTick as S1, withScopeId as T1, withKeys as O1, mergeProps as qf, createApp as j1, h as $1 } from "vue";
const Du = {
  state: A1({
    editMessage: null
  }),
...
function y3(D, u, f, e, F, t) {
  ...
  return b(), m("div", {
    ...
    y("div", {
      ...
      style: q({ background: f.messageColors.backgroundColor })
    }, [
    ...
    O(D.$slots, "default", {
      ...
      f.message.data.meta ? (b(), m("p", {
        ...
        style: q({ color: f.messageColors.color })
...
function Fe(D, u, f, e, F, t) {
  return b(), m("div", {
    ...
    style: q({ background: f.colors.emojiPicker.bg ?? "white" }),
    ...
    y("div", ee, [
      (b(!0), m(Ru, null, Qu(F.emojiData, (n) => (b(), m("div", {
        ...
        y("div", {
          ...
          style: q({ color: f.colors.emojiPicker.text ?? "#b8c3ca" })
        }, K(n.name), 5),
...
}, Ce = { style: { position: "relative" } }, ce = ["color"];
...
const le = /* @__PURE__ */ M(se, [["render", Ee], ["__scopeId", "data-v-d48a3251"]]), Be = {
  components: {
    IconBase: Mf
  },
  props: {
...
function _e(D, u, f, e, F, t) {
  return b(), m("div", {
    ...
    style: q({ background: f.colors.messageList.bg })
  }, [
...
}, Ie = { class: "icon-file-message" }, ze = ["src", "alt"], Ne = ["src", "alt"], Re = ["placeholder"], qe = { class: "sc-user-input--buttons" }, Le = {
  key: 0,
...
function Ve(D, u, f, e, F, t) {
  ...
  return b(), m("div", null, [
    ...
    y("form", {
      ...
      style: q({ background: f.colors.userInput.bg })
    }, [
      y("div", {
        ref: "userInput",
        role: "button",
...
const We = /* @__PURE__ */ M(Pe, [["render", Ve]]), Ge = {
  props: {
    participants: {
      type: Array,
      required: !0
...
}, Xe = { style: { "padding-top": "5px" } }, Ye = { style: { "text-align": "center" } }, Qe = ["src"];
...
const Je = /* @__PURE__ */ M(Ge, [["render", Ke], ["__scopeId", "data-v-4899c8d9"]]), Ze = {
  components: {
    Header: L1,
    MessageList: K3,
    UserInput: We,
...
function d2(D, u, f, e, F, t) {
  ...
  return b(), m("div", null, [
    f.showLauncher ? (b(), m("div", {
      ...
      f.newMessagesCount > 0 && !f.isOpen ? (b(), m("div", F2, K(f.newMessagesCount), 1)) : R("", !0),
      f.isOpen ? (b(), m("img", {
        key: 1,
...
const r2 = /* @__PURE__ */ M(t2, [["render", d2], ["__scopeId", "data-v-67e1ae28"]]);
var eu = "top", ou = "bottom", su = "right", tu = "left", AD = "auto", tD = [eu, ou, su, tu], qu = "start", Df = "end", i2 = "clippingParents", Qf = "viewport", Wu = "popper", o2 = "reference", pf = /* @__PURE__ */ tD.reduce(function(D, u) {
  return D.concat([u + "-" + qu, u + "-" + Df]);
}, []), yD = /* @__PURE__ */ [].concat(tD, [AD]).reduce(function(D, u) {
  return D.concat([u, u + "-" + qu, u + "-" + Df]);
}, []), s2 = "beforeRead", C2 = "read", c2 = "afterRead", E2 = "beforeMain", l2 = "main", B2 = "afterMain", b2 = "beforeWrite", p2 = "write", g2 = "afterWrite", UD = [s2, C2, c2, E2, l2, B2, b2, p2, g2];
function pu(D) {
...
function FD(D) {
  for (var u = cu(D), f = gf(D); f && v2(f) && Cu(f).position === "static"; )
    f = gf(f);
  return f && (pu(f) === "html" || pu(f) === "body" && Cu(f).position === "static") ? u : f || A2(D) || u;
}
function ef(D) {
...
function w2(D) {
  ...
  if (!(!t || !n)) {
    var c = y2(F.padding, f), o = ff(t), B = r === "y" ? eu : tu, E = r === "y" ? ou : su, A = f.rects.reference[d] + f.rects.reference[r] - n[r] - f.rects.popper[d], h = n[r] - f.rects.reference[r], w = FD(t), _ = w ? r === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, v = A / 2 - h / 2, p = c[B], g = _ - o[d] - c[E], k = _ / 2 - o[d] / 2 + v, x = mD(p, k, g), S = r;
...
function mf(D) {
  var u, f = D.popper, e = D.popperRect, F = D.placement, t = D.offsets, n = D.position, a = D.gpuAcceleration, r = D.adaptive, C = D.roundOffsets, d = C === !0 ? T2(t) : typeof C == "function" ? C(t) : t, c = d.x, o = c === void 0 ? 0 : c, B = d.y, E = B === void 0 ? 0 : B, A = t.hasOwnProperty("x"), h = t.hasOwnProperty("y"), w = tu, _ = eu, v = window;
  if (r) {
...
function _f(D, u) {
  return u === Qf ? VD(N2(D)) : Fu(u) ? q2(u) : VD(R2(Au(D)));
}
function L2(D) {
...
function V2(D) {
  ...
  if (!u.modifiersData[e]._skip) {
    for (var F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !0 : n, r = f.fallbackPlacements, C = f.padding, d = f.boundary, c = f.rootBoundary, o = f.altBoundary, B = f.flipVariations, E = B === void 0 ? !0 : B, A = f.allowedAutoPlacements, h = u.options.placement, w = ru(h), _ = w === h, v = r || (_ || !E ? [hD(h)] : U2(h)), p = [h].concat(v).reduce(function(Q, l) {
      return Q.concat(ru(l) === AD ? H2(u, {
        placement: l,
        boundary: d,
        rootBoundary: c,
        padding: C,
...
function D8(D) {
  var u = D.state, f = D.options, e = D.name, F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !1 : n, r = f.boundary, C = f.rootBoundary, d = f.altBoundary, c = f.padding, o = f.tether, B = o === void 0 ? !0 : o, E = f.tetherOffset, A = E === void 0 ? 0 : E, h = uD(u, {
    ...
    padding: c,
    altBoundary: d
  }), w = ru(u.placement), _ = Zu(u.placement), v = !_, p = ef(w), g = u8(p), k = u.modifiersData.popperOffsets, x = u.rects.reference, S = u.rects.popper, H = typeof A == "function" ? A(Object.assign({}, u.rects, {
    placement: u.placement
  })) : A, I = {
    x: 0,
    y: 0
...
function F8(D, u, f) {
  ...
  nf(e)) && (n = t8(u)), Fu(u) ? (a = Lu(u), a.x += u.clientLeft, a.y += u.clientTop) : e && (a.x = Ff(e))), {
  ...
  return function(a, r, C) {
    ...
    var d = {
      ...
      setOptions: function(w) {
        ...
        var _ = a8(C8([].concat(e, d.options.modifiers)));
        if (d.orderedModifiers = _.filter(function(I) {
          return I.enabled;
        }), process.env.NODE_ENV !== "production") {
          var v = s8([].concat(_, d.options.modifiers), function(I) {
            var U = I.name;
            return U;
          });
          if (o8(v), ru(d.options.placement) === AD) {
      ...
      forceUpdate: function() {
        if (!o) {
          ...
          d.rects = {
            reference: F8(_, FD(v), d.options.strategy === "fixed"),
            popper: ff(v)
...
var l8 = [P2, Z2, j2, _2, K2, W2, f8, x2, X2], B8 = /* @__PURE__ */ E8({
  defaultModifiers: l8
});
function b8() {
...
x1();
const m8 = /* @__PURE__ */ p8((D, u, f, e, F, t) => (b(), V("div", g8)));
kD.render = m8;
      ...
      $_applyHide: function() {
        ...
        return xu(function* () {
          ...
          if (clearTimeout(f.$_scheduleTimer), !!f.isShown) {
            f.skipTransition = e, k8(Pu, f), $u === f && ($u = null), f.isShown = !1, f.popperInstance && (yield f.$_refreshPopperOptions()), f.$_applyAttrsToTarget({
...
typeof document < "u" && typeof window < "u" && (a1 ? document.addEventListener("touchend", S8, vD ? {
  passive: !0,
  capture: !0
...
function ZD(D) {
  ...
  ZD.installed || (ZD.installed = !0, n1(Tu, u), D.directive("tooltip", q8), D.directive("close-popper", L8), D.component("v-tooltip", JD), D.component("VTooltip", JD), D.component("v-dropdown", QD), D.component("VDropdown", QD), D.component("v-menu", KD), D.component("VMenu", KD));
}
var M8 = {
